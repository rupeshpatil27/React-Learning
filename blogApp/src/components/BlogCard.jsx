...
const BlogCard = ({ data }) => {
  return (
    <div className="row-span-2 md:col-span-3 h-[23rem] md:h-full flex flex-col relative shadow-lg rounded-lg overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group">
